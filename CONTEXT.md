...
| **Must-have**       | A skill in the profile that should appear in a job. **Today:** drives _ranking_ only (see `docs/SEARCH-AND-EMBEDDINGS.md`). **Planned:** hard filter when list non-empty (refactor issue).                                                                                                                                                     |
